 ...
 * progress etc.</p> 
 * 
 * ATTENTION ! Actual Running Job implementations are not thread safe: do not call methods 
 * one the same Running Job instance in multiple threads. 
 * 
 * @see JobClient
 */
public interface RunningJob extends Serializable
{
	/**
