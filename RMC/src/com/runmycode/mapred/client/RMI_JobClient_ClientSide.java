 ...
 */
public abstract class RMI_JobClient_ClientSide implements JobClient
{
	private transient Logger logger = Logger.getLogger(com.runmycode.mapred.client.RMI_JobClient_ClientSide.class);
	...
	public RMI_JobClient_ClientSide(QueueConnectionFactory connectionFactory, Queue jobSubmissionQueue) throws JMSException 
	{
  ...
  public synchronized RunningJob submitJob(final JobConf job) throws Exception 
  {
	  ...
	  RMI_RunningJobClient runningJob = (RMI_RunningJobClient)createRunningJob(); 
			  
	  runningJob.setJobID(job.getJobID());
  ...
  public abstract RunningJob createRunningJob();
